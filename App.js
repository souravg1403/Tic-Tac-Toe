...
export default class App extends React.Component {
  ...
  winGame = () => {
    if ( (itemContainer[0] !== "empty") && (itemContainer[0] == itemContainer[1]) && itemContainer[1] == itemContainer[2] ) {
      this.setState({
        winMessage: (itemContainer[0] ? 'Cross' : 'Circle').concat(' win ...')
      })
    }

    else if  ( (itemContainer[3] !== "empty") && (itemContainer[3] == itemContainer[4]) && itemContainer[4] == itemContainer[5] ) {
      this.setState({
        winMessage: (itemContainer[3] ? 'Cross' : 'Circle').concat(' win ...')
      })
    }

    else if  ( (itemContainer[6] !== "empty") && (itemContainer[6] == itemContainer[7]) && itemContainer[7] == itemContainer[7] ) {
      this.setState({
        winMessage: (itemContainer[6] ? 'Cross' : 'Circle').concat(' win ...')
      })
    }
    ...
    else if  ( (itemContainer[2] !== "empty") && (itemContainer[2] == itemContainer[5]) && itemContainer[5] == itemContainer[5] ) {
      this.setState({
        winMessage: (itemContainer[6] ? 'Cross' : 'Circle').concat(' win ...')
      })
    }
